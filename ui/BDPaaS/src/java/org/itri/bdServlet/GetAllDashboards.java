 ...
 * @author A40385
 */
@WebServlet(urlPatterns = {"/getAllDashboards"})
public class GetAllDashboards extends HttpServlet {
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if(userID == null){
                ...
                ArrayList<Platform> platformList = platformDBManager.getK8SDashboardPlatforms();
