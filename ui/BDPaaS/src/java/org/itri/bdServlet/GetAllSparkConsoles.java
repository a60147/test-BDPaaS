 ...
 * @author A40385
 */
@WebServlet(urlPatterns = {"/getAllSparkConsoles"})
public class GetAllSparkConsoles extends HttpServlet {
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if(userID == null){
                ...
                ArrayList<Platform> platformList = platformDBManager.getSparkConsolePlatforms();
